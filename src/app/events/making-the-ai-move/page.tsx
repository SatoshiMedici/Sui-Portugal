...
export default function MakingTheAiMovePage() {
  ...
  return (
    <>
      {/* ─── Event Hero ─── */}
      <section className="relative bg-[#0A1628] pt-24 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-[#4DA2FF] hover:text-[#3d8de6] text-sm font-medium mb-8 transition-colors duration-300"
          >
